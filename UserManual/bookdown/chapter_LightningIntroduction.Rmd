...
[@George_Makov_Smith_1993] [Table 2 of the paper accidentally swapped the two estimates.].   Some discrepancy is to be expected since it is a Monte Carlo algorithm.
