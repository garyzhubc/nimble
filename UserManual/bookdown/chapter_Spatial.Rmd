...
$$`x[1:N] $\sim$ dcar_normal(adj, weights, num, tau, c, zero_mean)`$$
...
distribution.  Addition details of using this distribution are available using `help('CAR-Proper')`.
...
$$`x[1:N] $\sim$ dcar_proper(mu, C, adj, num, M, tau, gamma)`$$
...
## MCMC Sampling of CAR models {#sec:spatial_mcmc_sampling_car}
